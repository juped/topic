...
func TestLoadWriteMetadataRoundtrip(t *testing.T) {
	...
	cfg := &topic.Config{MetadataBranch: "test-metadata"}
...
func TestLoadMetadata_Empty(t *testing.T) {
	...
	cfg := &topic.Config{MetadataBranch: "empty-metadata"}
...
func TestAppendTopic(t *testing.T) {
	...
	cfg := &topic.Config{MetadataBranch: "test-append-topic"}
...
func TestAppendTopic_PreservesExisting(t *testing.T) {
	...
	cfg := &topic.Config{MetadataBranch: "test-append-preserve"}
...
func TestUpdateTopic(t *testing.T) {
	...
	cfg := &topic.Config{MetadataBranch: "test-update-topic"}
...
func TestUpdateTopic_NotFound(t *testing.T) {
	...
	cfg := &topic.Config{MetadataBranch: "test-update-notfound"}
...
func TestAppendReconciliation(t *testing.T) {
	...
	cfg := &topic.Config{MetadataBranch: "test-append-rec"}
